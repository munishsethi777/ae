...
public class CampaignDataStore implements CampaignDataStoreI, RowMapper {
	...
	public void Save(Campaign campaign) {
		...
		try{
			...
			logger.error("Error occured while saving a campaign "+ e.getMessage());
		}	
	}
	...
	public void saveUserGroups(Campaign campaign){
		...
		for(UserGroup userGroup : campaign.getUserGroups()){
			...
			persistenceMgr.excecuteUpdate(SAVE_USERGROUPS, params);
				...
				logger.error("Error setting usergroups on campaign"+ e.getMessage());
			}
		}
	...
	public List<Campaign> findByProjectSeq(long seq) {
		...
		//return (List<Campaign>) persistenceMgr.executePSQuery(SELECT_BY_PROJECT_SEQ, params, this);	
	}
	
	public List<Campaign> findAll() {
		return this.getCampaignSets(SELECT, null);
		//return (List<Campaign>)persistenceMgr.executePSQuery(SELECT, null, this);	
	}
	...
	public Campaign findBySeq(long seq) {
		...
		//return (Campaign) persistenceMgr.executeSingleObjectQuery(SELECT_BY_SEQ, params, this);
	}
	...
	public List<Campaign> findByUserSeq(long seq) {
		Object [] params = new Object [] {seq};
		return (List<Campaign>) persistenceMgr.executePSQuery(FIND_BY_USER_SEQ, params, this);	
	}
	...
	public int getCampaignSetSeq(long campaignSeq, long setSeq) {
		...
		Object campaignSetSeq = persistenceMgr.executeSingleObjectQuery(sql, params, new RowMapper() {
			@Override
